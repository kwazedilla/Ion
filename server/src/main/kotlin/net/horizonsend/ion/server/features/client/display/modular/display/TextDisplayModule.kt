...
abstract class TextDisplayModule(
	...
	final override val entity: TextDisplay = createEntity()
	...
	final override fun createEntity(): TextDisplay {
		...
		return craftEntity.getNMSData(location.x, location.y, location.z).apply { id = this@TextDisplayModule.id }
	}
